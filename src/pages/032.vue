...
function updateNumber(value) {
  ...
  if (value > 0) {
    animationClass.value.push('fadeOutUp')
  }
  else {
    animationClass.value.push('fadeOutDown')
  }
}
</script>
...
<template>
  <div class="frame">
    <div class="counter">
      <div class="minus" @click="updateNumber(-1)">
        <div class="line" />
      </div>
      <div class="number">
        <span class="fadeIn" :class="animationClass">
          {{ num }}
        </span>
        <span class="fadeInUp">
          {{ num }}
      ...
      <div class="plus" @click="updateNumber(1)">
        <div class="line-h" />
        <div class="line-v" />
      </div>
    </div>
