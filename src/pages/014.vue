...
<template>
  <div class="frame">
    <div class="card">
      <div class="flip">
        <div class="front">
          <img src="https://100dayscss.com/codepen/bycicle.svg" alt="svg">
          <div class="street">
            <div v-for="(i, key) in 9" :key :class="`stripe-${i}`" />
          </div>
        </div>
        <div class="back">
          <img src="https://100dayscss.com/codepen/helicopter.svg" alt="svg">
          <div class="sky">
            <div v-for="(i, key) in 9" :key :class="`cloud-${i}`" />
          </div>
        </div>
      </div>
    </div>
  </div>
  <TheCd to="013" class="op-5" :bt="35" />
  <TheCd to="015" :bt="10" />
</template>
